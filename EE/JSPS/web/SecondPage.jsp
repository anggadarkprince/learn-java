        ...
        <td style="width:75%;height:80%;">
            ...
            <table style="width:100%;" border="1">
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= dbUIDFail %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= dbUIDFail %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= dbUIDSuccess %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= dbUIDSuccess %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= uid %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= uid %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= scode %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= scode %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= acode %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= acode %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= pcode %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= pcode %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= pcode2 %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= pcode2 %>
                    </td>
                    <%
                        }
                    %>
                ...
                <tr>
                    ...
                    %>
                    <td style="width:65%;background-color:#e5b75b;"><%= lcode %>
                    </td>
                    <%
                    } else {
                    %>
                    <td style="width:65%;background-color:#6599ff;"><%= lcode %>
                    </td>
                    <%
                        }
                    %>
